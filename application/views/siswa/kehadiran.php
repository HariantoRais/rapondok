    ...
    <section class="content">
      <div class="box box-primary color-palette-box">
        <div class="box-header with-border" style="background-color: #3c8dbc;color: white; font-size: 18px;">
          <i class="fa fa-fw fa-edit"></i>INPUT KEHADIRAN
          <span class="pull-right"><input type="button" class="btn btn-sm btn-warning" value="Kembali" onclick="history.back(-1)" /></span>
        </div>
        <div class="box-body">
			<form action="<?php echo base_url().'wakel/crud/update_kehadiran/'.$url; ?>" method="post">
						...
						<table class="table table-striped">
							<tbody>
								...
								<tr>
									...
									<td><input onkeypress="return angka(event)" required="" type="number" class="form-control" name="sakit[]" value="<?php echo $sis->sakit ?>"></td>

									<td><input onkeypress="return angka(event)" required="" type="number" class="form-control" name="izin[]" value="<?php echo $sis->izin ?>"></td>

									<td><input onkeypress="return angka(event)" required="" type="number" class="form-control" name="alfa[]" value="<?php echo $sis->alfa ?>"></td>
								</tr>
