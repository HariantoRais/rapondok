    ...
    <section class="content">
      <div class="box box-primary color-palette-box">
        <div class="box-header with-border" style="background-color: #3c8dbc;color: white; font-size: 18px;">
          <i class="fa fa-fw fa-edit"></i>CATATAN WALI KELAS
          <span class="pull-right"><input type="button" class="btn btn-sm btn-warning" value="Kembali" onclick="history.back(-1)" /></span>
        </div>
        <div class="box-body">
			<form action="<?php echo base_url().'wakel/crud/update_catatan/'.$url; ?>" method="post">
						...
						<table class="table table-striped">
							<tbody>
								<tr>
								  ...
								  <td align="center" width="75%"><b>Catatan Wali Kelas</b></td>
								</tr>
								<?php $no = 1; 
								...
								<tr>
									...
									<td>
										<textarea name="catatan[]" class="form-control" rows="4"> <?php echo $sis->catatan ?></textarea>
									</td>
